...
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/forms */ "./resources/js/modules/forms.js");
...
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/cards */ "./resources/js/modules/cards.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/timer */ "./resources/js/modules/timer.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimerId);
  }, 3000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.timer', "2021-12-17");
});
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(id, src, title, descr, price, oldPrice, parentSelector) {
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        element.innerHTML = "\n                        <img src=".concat(this.src, ">\n                        <h3 class=\"menu__item-subtitle\">").concat(this.title, "</h3>\n                        <div class=\"menu__item-descr\">").concat(this.descr, "</div>\n                        <div class=\"menu__item-divider\"></div>\n                        <div class=\"menu__item-price\">\n                        <div><a class=\"btn btn-danger\" href=\"{{ route('course', ").concat(this.id, ") }}\">\n                        \u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a></div>\n                            <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                            <div class=\"menu__item-total\"><span class=\"cena\">").concat(this.oldPrice, "\u0442\u0433</span>\n                            <div><span>").concat(this.price, "\u0442\u0433</span></div>\n                            </div>\n                        </div>\n                    ");
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://okucenter.kz/api/get_courses').then(function (data) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal */ "./resources/js/modules/modal.js");
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/services */ "./resources/js/services/services.js");
...
function slider(_ref) {
  var sliderMain = _ref.sliderMain,
      currentCount = _ref.currentCount,
      nextSlide = _ref.nextSlide,
      slideField = _ref.slideField,
      totalCount = _ref.totalCount,
      allSlides = _ref.allSlides,
      wrapperSlides = _ref.wrapperSlides,
  ...
  next.addEventListener('click', function () {
    ...
    slidesField.style.transform = "translateX(-".concat(position, "px)");
...
function _getResource() {
  _getResource = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(url) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("To ".concat(url, " could not post data ").concat(res.status));
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/style/style"], function() { return __webpack_require__("./resources/js/app.js"); })
/******/ 	__webpack_require__.O(undefined, ["css/app","css/style/style"], function() { return __webpack_require__("./resources/sass/style.scss"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/style/style"], function() { return __webpack_require__("./resources/css/app.css"); })
